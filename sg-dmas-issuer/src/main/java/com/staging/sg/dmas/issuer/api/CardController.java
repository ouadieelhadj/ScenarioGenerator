...
public class CardController {
    ...
    public CardController(DmasCardRepository cardRepo) {
    ...
    public ResponseEntity<?> createCard(@RequestBody CardRequest req) {
        try {
            ...
            DmasCard card = cardRepo.findByPan(req.pan).orElseGet(DmasCard::new);
            card.setPan(req.pan);
            card.setPin(req.pin);
    ...
    private Map<String,Object> toMap(DmasCard c) {
