...
public class DmcsAcquirerController {
    ...
    public ResponseEntity<?> generate(
        ...
        try {
            ...
            AcqIpmFile ipmFile = generatorService.generate(
    ...
    // GET /api/dmcs/files
    @GetMapping("/files")
    public ResponseEntity<List<AcqIpmFile>> listFiles() {
    ...
    public ResponseEntity<?> getFile(@PathVariable Long id) {
        AcqIpmFile file = generatorService.getFile(id);
        if (file == null)
    ...
    public ResponseEntity<List<AcqIpmRecord>> getRecords(@PathVariable Long id) {
    ...
    public ResponseEntity<Map<String, Object>> status() {
        ...
        body.put("application", "SG DMCS Acquirer");
