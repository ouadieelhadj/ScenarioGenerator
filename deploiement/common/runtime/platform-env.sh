...
PLATFORM_ENV_KEYS=(
  ...
  PSQL PGDATA POSTGRES_SERVICE_NAME POSTGRES_LOG DB_HOST DB_PORT DB_NAME DB_USER
  MAVEN_REPO PLATFORM_RUNTIME
...
export POSTGRES_LOG="${POSTGRES_LOG:-$ROOT/runtime/postgres/postgresql.log}"
