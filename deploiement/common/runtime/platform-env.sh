...
PLATFORM_ENV_KEYS=(
  ...
  DMAS_DMC_RUNTIME DMAS_DMC_LOG_DIR DMAS_DMC_PID_DIR
  DMAS_MEMBER_URL DMAS_MASTERCARD_URL DMAS_MASTERCARD_ISO_PORT
  DMCS_ACQUIRER_URL DMCS_ISSUER_URL
  DMAS_MEMBER_INTERFACE DMAS_MASTERCARD_INTERFACE
  DMAS_MEMBER_GROUP_ID DMAS_MEMBER_BANK_CODE DMAS_ADMIN_LOGIN DMCS_BASIC_USER
  DMAS_MEMBER_LMK_FILE DMAS_MASTERCARD_LMK_FILE
