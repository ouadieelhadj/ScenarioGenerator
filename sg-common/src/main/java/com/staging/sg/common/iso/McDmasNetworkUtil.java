 ...
 */
@Component
public class McDmasNetworkUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(McDmasNetworkUtil.class);

    private final McPackagerEbcdic packager;

    public McDmasNetworkUtil(McPackagerEbcdic packager) {
