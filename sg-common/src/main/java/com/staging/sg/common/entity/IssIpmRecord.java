...
@Entity
@Table(name = "iss_ipm_records")
public class IssIpmRecord {
    @Id
    ...
    private IssIpmFile ipmFile;

    @Column(name = "iss_auth_id")                         private Long    issAuthId;
    ...
    @Column(name = "de030_orig_amount")                   private Long    de030OrigAmount;
    ...
    @Column(name = "de072_data_record", length = 255)     private String  de072DataRecord;
    @Column(name = "de093_dest_id",  length = 11)         private String  de093DestId;
    @Column(name = "de094_origin_id",length = 11)         private String  de094OriginId;
    @Column(name = "pds_data",       columnDefinition = "TEXT") private String pdsData;
    ...
    @Column(name = "status",         length = 10)         private String  status = "OK";
    ...
    public IssIpmFile    getIpmFile()           { return ipmFile; }
    public Long          getIssAuthId()         { return issAuthId; }
    ...
    public Long          getDe030OrigAmount()   { return de030OrigAmount; }
    ...
    public String        getDe072DataRecord()   { return de072DataRecord; }
    public String        getDe093DestId()       { return de093DestId; }
    public String        getDe094OriginId()     { return de094OriginId; }
    ...
    public void setIpmFile(IssIpmFile v)     { this.ipmFile = v; }
    public void setIssAuthId(Long v)         { this.issAuthId = v; }
    ...
    public void setDe030OrigAmount(Long v)   { this.de030OrigAmount = v; }
    ...
    public void setDe072DataRecord(String v) { this.de072DataRecord = v; }
    public void setDe093DestId(String v)     { this.de093DestId = v; }
    public void setDe094OriginId(String v)   { this.de094OriginId = v; }
    public void setPdsData(String v)         { this.pdsData = v; }
