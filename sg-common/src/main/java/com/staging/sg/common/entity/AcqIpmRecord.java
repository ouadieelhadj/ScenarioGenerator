...
@Entity
@Table(name = "acq_ipm_records")
public class AcqIpmRecord {
    @Id
    ...
    private AcqIpmFile ipmFile;

    @Column(name = "acq_auth_id")                         private Long    acqAuthId;
    ...
    public AcqIpmFile    getIpmFile()           { return ipmFile; }
    public Long          getAcqAuthId()         { return acqAuthId; }
    ...
    public void setIpmFile(AcqIpmFile v)     { this.ipmFile = v; }
    public void setAcqAuthId(Long v)         { this.acqAuthId = v; }
