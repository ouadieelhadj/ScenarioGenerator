...
@Component
public class McDmasMastercardClient {

    private static final Logger log = LoggerFactory.getLogger(McDmasMastercardClient.class);
    ...
    private final McDmasMastercardHandler mcDmasIssuer;

    public McDmasMastercardClient(JposHsmService hsm, McDmasKekRepository kekRepo, McDmasMastercardKeyRepository issKeyRepo,
                          @Lazy McDmasMastercardHandler mcDmasIssuer) {
        this.hsm = hsm;
    ...
    private void processReceivedPek(ISOMsg m) {
        try {
            ...
            McDmasMastercardKey ik = issKeyRepo.findByMemberGroupIdAndKeyTypeAndStatus(memberGroup, "PEK", "ACTIVE")
