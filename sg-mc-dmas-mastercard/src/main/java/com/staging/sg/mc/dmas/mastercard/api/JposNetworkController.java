...
import com.staging.sg.mc.dmas.mastercard.network.McDmasMastercardClient;
...
public class JposNetworkController {
    ...
    private final McDmasMastercardClient client;

    public JposNetworkController(McDmasMastercardClient client) {
        this.client = client;
    }
