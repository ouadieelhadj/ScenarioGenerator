...
export enum Permission {
  ...
  ONBOARDING_PROSPECT_CREATE = 'ONBOARDING_PROSPECT_CREATE',
  ONBOARDING_IDENTITY_LINK = 'ONBOARDING_IDENTITY_LINK',
  ONBOARDING_KYC_REVIEW = 'ONBOARDING_KYC_REVIEW',
  ONBOARDING_APPROVE = 'ONBOARDING_APPROVE',
  ONBOARDING_PROVISION = 'ONBOARDING_PROVISION',
}
