 ...
 */
@Component
public class McDmasMemberServer {

    private static final Logger log = LoggerFactory.getLogger(McDmasMemberServer.class);
    ...
    public void start() {
        try {
            ...
            serverThread.start();
            log.info("[JPOS-SRV] ISOServer demarre sur :{} (McDmasLengthChannel/EBCDIC)", serverPort);
        } catch (Exception e) {
