...
import com.staging.sg.mc.dmas.member.network.McDmasNetworkManager;
...
public class McDmasNetworkController {
    ...
    private static final Logger log = LoggerFactory.getLogger(McDmasNetworkController.class);

    private final McDmasNetworkManager network;

    public McDmasNetworkController(McDmasNetworkManager network) {
