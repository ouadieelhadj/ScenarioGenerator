...
public class FraudFeatureSnapshot {
    ...
    public static FraudFeatureSnapshot create(String memberId,String sectorId,String transactionReference,String version,String json){
        FraudFeatureSnapshot value=new FraudFeatureSnapshot(); value.id=UUID.randomUUID(); value.memberId=memberId; value.sectorId=sectorId;
